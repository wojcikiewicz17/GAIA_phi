...
def animate_triangle(a: float, b: float):
    ...
    lines = [
        ...
        f"  • Altura do triângulo equilátero unitário",
        f"  • Meia-diagonal normalizada do cubo unitário",
        f"  • Fator de inclinação natural 3–6–9",
    ]
...
def show_full_composition(a: float, b: float):
    ...
    print()
    print_centered("Pronto para ser embutido no seu kernel, banner ou CLI.", "dim")
    print()
