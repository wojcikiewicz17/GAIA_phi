...
# HEADER da VERSÃO 1 (mantido exatamente)
HEADER = r"""____       _        __      _ _ _      _
...
def spin_geometries():
    ...
    for i in range(6):
        ...
        splash_header()
        print()
        print_left("GEOMETRIA RAFAELIANA 3–6–9", "white")
        print()
...
def show_full_composition(a: float, b: float):
    ...
    # Bloco 1 – Triângulo
    print_left("NÚCLEO DE DIFERENÇA (Teorema de Rafael)", "yellow")
    print()
    ...
    clear()
    splash_header()
    print_left("OVERDRIVE 2D E 3D", "green")
    print()
    print_left(QUADRADO, "cyan")
    print()
    print_left(CUBO, "magenta")
    print()
    print_left("d₂D = L√2 • d₃D = L√3", "white")
    sleep(2.5)

    # Bloco 3 – 3–6–9
    clear()
    splash_header()
    print_left("MAPA 3–6–9 RAFAELIA", "blue")
    print()
    ...
    clear()
    splash_header()
    print_left("FIAT LUX · TEOREMA DE RAFAEL • φ_R ATIVO", "magenta")
    print()
    print_left("Pronto para ser embutido no seu kernel, banner ou CLI.", "dim")
    print()
